...
const LocalPickupMap = () => {
  ...
  const cities = [
    { id: "mumbai", name: "Mumbai", lat: 19.076, lng: 72.8777, locations: 45 },
  ...
  const pickupLocations = {
    mumbai: [
      ...
      },
      {
        id: 4,
        name: "Malad West Hub",
        address: "Malad West Station Road",
        sellers: 6,
        distance: "8.2 km",
        available: true,
      },
  ...
  return (
    <section className="pt-6 sm:pt-8 lg:pt-10 pb-12 sm:pb-14 lg:pb-16 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Find convenient pickup points near you for safe and easy item
            collection
          </p>
        </div>
              ...
              <div className="relative h-96">
                ...
                <div className="absolute top-4 left-4 bg-card/95 backdrop-blur-sm rounded-lg p-3 shadow-eco-card">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">
                    {locations?.filter((loc) => loc?.available)?.length}{" "}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Select a convenient pickup point near you
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Meet the seller and inspect your purchase
                    </p>
                  </div>
                </div>
              </div>
          ...
          {[
            {
              icon: "Shield",
              title: "Safe Meetings",
              desc: "Secure, public locations",
            },
            {
              icon: "Clock",
              title: "Flexible Hours",
              desc: "7 AM to 10 PM daily",
            },
            {
              icon: "Users",
              title: "Community Verified",
              desc: "Trusted by locals",
            },
            {
              icon: "MapPin",
              title: "Easy to Find",
              desc: "Near metro & bus stops",
            },
          ]?.map((benefit, index) => (
            <div
              key={index}
              className="bg-card rounded-xl p-6 shadow-eco-card border border-border text-center"
            >
