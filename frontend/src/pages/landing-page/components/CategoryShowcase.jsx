...
const CategoryShowcase = () => {
  ...
  return (
    <section className="section-y-tight bg-background">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {categories?.map((category) => (
            ...
            >
              {/* Main Category Card */}
              <div
                className={`relative bg-card rounded-2xl p-6 shadow-eco-card border border-border hover:shadow-eco-cta transition-all duration-300 transform hover:-translate-y-2 ${category?.bgColor}`}
              >
                {/* Background Gradient */}
                <div
                ...
                <div className="relative z-10 text-center space-y-4">
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 mx-auto rounded-2xl ${category?.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
                    <Icon
                      name={category?.icon}
                      size={32}
